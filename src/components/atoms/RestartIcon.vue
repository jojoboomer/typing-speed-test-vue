...
const fillColor = computed(() => props.color?.startsWith('fill-') ? props.color : 'fill-black')

</script>

<template>
  <svg xmlns="http://www.w3.org/2000/svg" :width="width ? width : 20" :height="height ? height : 20" fill="none"
    viewBox="0 0 20 20">
